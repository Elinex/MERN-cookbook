...
// If an id is given, look for the user in the data array. However, If the given id is "all", 
// it will return the whole list of users:
...
// An id needs to be provided in order to update a specific user in the data array:
...
// It will look for the user in the data array and remove it:
