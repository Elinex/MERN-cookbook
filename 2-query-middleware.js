...
// Define pre and post hooks for the count, find, findOne, and update 
// methods:
...
// Once the connection to the database is successfully made, create a 
// document, save it, and use the methods for which we defined hooks for:
