...
// application is connected to MongoDB first before allowing next route 
...
// Configure express-session middleware to store sessions in the Mongo 
// database instead of storing in memory:
app.use(session({
